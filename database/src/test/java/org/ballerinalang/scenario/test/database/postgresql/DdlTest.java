...
public class DdlTest extends ScenarioTestBase {
    ...
    public void setUp() throws Exception {
        ...
        ddlCompileResult = BCompileUtil
                .compile(Paths.get(resourcePath.toString(), "bal-src", "postgresql", "ddl-test.bal").toString());
    }
    ...
    public void cleanup() throws Exception {
        ...
        DatabaseUtil.executeSqlFile(jdbcUrl, userName, password,
                Paths.get(resourcePath.toString(), "sql-src", "postgresql", "ddl-test-cleanup.sql"));
    }
}
