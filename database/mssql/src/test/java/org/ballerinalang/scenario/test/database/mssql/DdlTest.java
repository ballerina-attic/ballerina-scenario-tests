...
public class DdlTest extends ScenarioTestBase {
    ...
    @Test(description = "Tests table procedure creation DDL query")
    public void testCreateProcedure() {
        BValue[] returns = BRunUtil.invoke(ddlCompileResult, "testCreateProcedure");
        AssertionUtil.assertUpdateQueryReturnValue(returns[0], 1);
    }

    @Test(description = "Tests table procedure alteration DDL query")
    public void testAlterProcedure() {
        BValue[] returns = BRunUtil.invoke(ddlCompileResult, "testAlterProcedure");
        AssertionUtil.assertUpdateQueryReturnValue(returns[0], 1);
    }

    @Test(description = "Tests table procedure dropping DDL query")
    public void testDropProcedure() {
        BValue[] returns = BRunUtil.invoke(ddlCompileResult, "testDropProcedure");
        AssertionUtil.assertUpdateQueryReturnValue(returns[0], 0);
    }

    @Test(description = "Tests table index creation DDL query")
    public void testCreateIndex() {
        BValue[] returns = BRunUtil.invoke(ddlCompileResult, "testCreateIndex");
        AssertionUtil.assertUpdateQueryReturnValue(returns[0], 0);
    }

    @Test(description = "Tests table index dropping DDL query")
    public void testDropIndex() {
        BValue[] returns = BRunUtil.invoke(ddlCompileResult, "testDropIndex");
        AssertionUtil.assertUpdateQueryReturnValue(returns[0], 0);
    }
