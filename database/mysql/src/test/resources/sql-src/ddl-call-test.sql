...
/
CREATE PROCEDURE CALL_TEST_IN_INTEGER_TYPES (IN p_id_in INTEGER, IN p_bitVal BIT(8), IN p_tinyIntVal TINYINT,
IN p_smallIntVal SMALLINT, IN p_mediumIntVal MEDIUMINT, IN p_intVal INT, IN p_bigIntVal BIGINT)
MODIFIES SQL DATA
BEGIN
    INSERT INTO SELECT_UPDATE_TEST_INTEGER_TYPES VALUES(p_id_in, p_bitVal, p_tinyIntVal, p_smallIntVal, p_mediumIntVal,
    p_intVal, p_bigIntVal);
END
/
CREATE PROCEDURE CALL_TEST_OUT_INTEGER_TYPES (IN p_id INTEGER, OUT p_bitVal BIT, OUT p_tinyIntVal TINYINT,
OUT p_smallIntVal SMALLINT, OUT p_mediumIntVal MEDIUMINT, OUT p_intVal INT, OUT p_bigIntVal BIGINT)
READS SQL DATA
BEGIN
    SELECT BIT_VAL INTO p_bitVal FROM SELECT_UPDATE_TEST_INTEGER_TYPES WHERE ID = p_id;
    SELECT TINYINT_VAL INTO p_tinyIntVal FROM SELECT_UPDATE_TEST_INTEGER_TYPES WHERE ID = p_id;
    SELECT SMALLINT_VAL INTO p_smallIntVal FROM SELECT_UPDATE_TEST_INTEGER_TYPES WHERE ID = p_id;
    SELECT MEDIUMINT_VAL INTO p_mediumIntVal FROM SELECT_UPDATE_TEST_INTEGER_TYPES WHERE ID = p_id;
    SELECT INTEGER_VAL INTO p_intVal FROM SELECT_UPDATE_TEST_INTEGER_TYPES WHERE ID = p_id;
    SELECT BIGINT_VAL INTO p_bigIntVal FROM SELECT_UPDATE_TEST_INTEGER_TYPES WHERE ID = p_id;
END
/
CREATE PROCEDURE CALL_TEST_INOUT_INTEGER_TYPES (IN p_id_in INTEGER, IN p_id_out INTEGER, INOUT p_bitVal BIT(8), INOUT p_tinyIntVal TINYINT,
INOUT p_smallIntVal SMALLINT, INOUT p_mediumIntVal MEDIUMINT, INOUT p_intVal INT, INOUT p_bigIntVal BIGINT)
MODIFIES SQL DATA
BEGIN
    INSERT INTO SELECT_UPDATE_TEST_INTEGER_TYPES VALUES(p_id_in, p_bitVal, p_tinyIntVal, p_smallIntVal, p_mediumIntVal,
    p_intVal, p_bigIntVal);
    SELECT BIT_VAL INTO p_bitVal FROM SELECT_UPDATE_TEST_INTEGER_TYPES WHERE ID = p_id_out;
    SELECT TINYINT_VAL INTO p_tinyIntVal FROM SELECT_UPDATE_TEST_INTEGER_TYPES WHERE ID = p_id_out;
    SELECT SMALLINT_VAL INTO p_smallIntVal FROM SELECT_UPDATE_TEST_INTEGER_TYPES WHERE ID = p_id_out;
    SELECT MEDIUMINT_VAL INTO p_mediumIntVal FROM SELECT_UPDATE_TEST_INTEGER_TYPES WHERE ID = p_id_out;
    SELECT INTEGER_VAL INTO p_intVal FROM SELECT_UPDATE_TEST_INTEGER_TYPES WHERE ID = p_id_out;
    SELECT BIGINT_VAL INTO p_bigIntVal FROM SELECT_UPDATE_TEST_INTEGER_TYPES WHERE ID = p_id_out;
END
/
CREATE PROCEDURE CALL_TEST_OUT_FIXED_POINT_TYPES (IN p_id INTEGER, OUT p_decimalVal DECIMAL(5,2),
OUT p_numericVal NUMERIC(7,3))
READS SQL DATA
BEGIN
...
END
/
CREATE PROCEDURE CALL_TEST_INOUT_FIXED_POINT_TYPES (IN p_id_in INTEGER, IN p_id_out INTEGER,
INOUT p_decimalVal DECIMAL(5,2), INOUT p_numericVal NUMERIC(7,3))
MODIFIES SQL DATA
BEGIN
    INSERT INTO SELECT_UPDATE_TEST_FIXED_POINT_TYPES VALUES(p_id_in, p_decimalVal, p_numericVal);
